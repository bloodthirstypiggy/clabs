...
const char *msgs[] = { "0. Quit the tree", "1. Add item to the tree", "2. Find item by key", "3. Delete element by key", "4. Show", "5. Show in range", "6. Timing", "7. Find nearest element"};
